if (typeof StickySections === 'undefined') {
    class StickySections {
        ...
        initContainer() {
            // Ensure this only works for the container with sticky sections
        ...
        handleSections() {
            ...
            // Adjust scroll value based on the container and section positions
    ...
    // Only initialize StickySections for the case-study section
    const caseStudySection = document.getElementById('case-study');
    if (caseStudySection && document.body.classList.contains('case-study')) {
        const sectionsContainer = caseStudySection.querySelectorAll('[data-sticky-sections]');
